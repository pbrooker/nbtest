    ...
    function add_js($script, $type = 'import', $defer = false)
    {
        ...
        switch ($type)
        {
            ...
            case 'embed_reload':
                ...
                $js .= $script . PHP_EOL;
                $js .= "};" . PHP_EOL;
                $js .= "window.onunload = function(){" . PHP_EOL;
                $js .= $script . PHP_EOL;
                $js .= "};" . PHP_EOL;
                $js .= "$(window).bind('pageshow', function(event) {" . PHP_EOL;
                $js .= "if (event.originalEvent.persisted) {" . PHP_EOL;
                $js .= $script . PHP_EOL;
                $js .= "};" . PHP_EOL;
                $js .= "});" . PHP_EOL;
                $js .= "window.onpageshow = function(event) {" . PHP_EOL;
                $js .= "if (event.persisted) {" . PHP_EOL;
                $js .= $script . PHP_EOL;
                $js .= "};" . PHP_EOL;
                $js .= "};" . PHP_EOL;
                $js .= '</script>'.PHP_EOL;
